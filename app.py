...
st.set_page_config(
    ...
    page_icon="👤",
    layout="wide",
    initial_sidebar_state="expanded"  # Menú visible por defecto
)

# ============================================
# CSS NARRATIVO MEJORADO
# ============================================
...
<style>
    ...
    * { 
    ...
    /* Fondo con colores Sura */
    .main { 
        background: linear-gradient(135deg, #0072CE 0%, #00C9DB 50%, #E8F4F8 100%);
        padding: 20px;
    }
    
    /* Indicador de menú flotante */
    .menu-indicator {
        position: fixed;
        top: 80px;
        left: 20px;
    ...
    .story-section.solution {
        background: linear-gradient(135deg, #00C9DB 0%, #0072CE 100%);
        color: white;
    }
    ...
    .character-avatar {
        font-size: 4em;
        filter: drop-shadow(0 4px 8px rgba(0,114,206,0.3));
    }
    ...
    .stButton>button {
        background: linear-gradient(135deg, #0072CE 0%, #00C9DB 100%) !important;
    ...
    .stButton>button:hover {
        ...
        box-shadow: 0 6px 25px rgba(0,201,219,0.5) !important;
    }
    ...
    [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #003366 0%, #0072CE 100%);
        border-right: 3px solid #00C9DB;
    }
    ...
    [data-testid="stSidebar"] .stInfo {
        background: rgba(0,201,219,0.2) !important;
        border-left: 3px solid #00C9DB !important;
    }
...
# PASO 2: EL CAMBIO
    ...
    <div class="story-section">
        ...
        <div style="text-align: center; margin: 40px 0;">
            ...
            <p style="font-size: 1.2em; color: #0072CE; margin-top: 20px;">
    ...
    <div class="story-section">
        ...
        <div style="background: linear-gradient(135deg, #E8F4F8 0%, #fff 100%); padding: 30px; border-radius: 15px; margin: 30px 0; border: 2px solid #0072CE;">
            <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,114,206,0.2);">
                ...
                <button style="background: linear-gradient(135deg, #0072CE, #00C9DB); color: white; border: none; padding: 12px 30px; border-radius: 8px; font-weight: 600; cursor: pointer;">
                    Ver opciones
                </button>
            </div>
        </div>
        
        <h3 style="color: #0072CE; margin: 50px 0 30px 0;">🔄 El Nuevo Flujo (3 minutos)</h3>
        ...
        <div class="timeline">
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    ...
                    <p style="background: #E8F4F8; padding: 10px; border-radius: 8px; margin-top: 10px;">
        ...
        <div style="text-align: center; margin: 50px 0;">
            <h3 style="margin: 0 0 20px 0; color: #0072CE;">Nuevo viaje emocional</h3>
            <div class="emotion-meter" style="background: linear-gradient(135deg, #E8F4F8, white);">
                <div class="emotion-point">
                    <span class="emoji">🤔</span>
                    <span class="label" style="color: #0072CE;">Necesidad</span>
                </div>
                <div class="emotion-point">
                    <span class="emoji">😊</span>
                    <span class="label" style="color: #0072CE;">Descubrimiento</span>
                </div>
                <div class="emotion-point">
                    <span class="emoji">💡</span>
                    <span class="label" style="color: #0072CE;">Comparación</span>
                </div>
                <div class="emotion-point">
                    <span class="emoji">✅</span>
                    <span class="label" style="color: #0072CE;">Decisión</span>
                </div>
                <div class="emotion-point">
                    <span class="emoji">❤️</span>
                    <span class="label" style="color: #0072CE;">Alivio</span>
                </div>
            </div>
        </div>
    ...
    <div class="story-section action">
        ...
        <div class="principles-grid">
            <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                ...
                <h4 style="color: #0072CE; margin: 0 0 15px 0;">Effortless Score</h4>
                <p style="margin: 0 0 10px 0;"><strong>Pregunta:</strong> "¿Qué tan fácil fue?" (1-5)</p>
                <p style="margin: 0; color: #666; font-size: 0.95em;">
                    <strong>Por qué:</strong> Mide carga cognitiva y emocional
                </p>
            </div>
            
            <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <div style="font-size: 2.5em; margin-bottom: 15px;">📱</div>
                <h4 style="color: #0072CE; margin: 0 0 15px 0;">Micro-interacciones</h4>
            ...
            <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                ...
                <h4 style="color: #0072CE; margin: 0 0 15px 0;">Time to Relief</h4>
                <p style="margin: 0 0 10px 0;"><strong>Métrica:</strong> Desde "problema" hasta "alivio"</p>
                <p style="margin: 0; color: #666; font-size: 0.95em;">
            ...
            <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <div style="font-size: 2.5em; margin-bottom: 15px;">💬</div>
                <h4 style="color: #0072CE; margin: 0 0 15px 0;">Sentiment Analysis</h4>
                <p style="margin: 0 0 10px 0;"><strong>Métrica:</strong> Análisis de texto post-proceso</p>
                <p style="margin: 0; color: #666; font-size: 0.95em;">
                    <strong>Por qué:</strong> Captura emociones reales
                </p>
            </div>
            
            <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <div style="font-size: 2.5em; margin-bottom: 15px;">🔄</div>
                <h4 style="color: #0072CE; margin: 0 0 15px 0;">Repeat Confidence</h4>
                <p style="margin: 0 0 10px 0;"><strong>Métrica:</strong> % que vuelve en 6 meses</p>
                <p style="margin: 0; color: #666; font-size: 0.95em;">
            ...
            <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <div style="font-size: 2.5em; margin-bottom: 15px;">📞</div>
                <h4 style="color: #0072CE; margin: 0 0 15px 0;">Support Deflection</h4>
                <p style="margin: 0 0 10px 0;"><strong>Métrica:</strong> % que NO llama después</p>
                <p style="margin: 0; color: #666; font-size: 0.95em;">
                    <strong>Por qué:</strong> Si es claro, no hay dudas
                </p>
            </div>
        </div>
...
# PASO 7: CIERRE PERSONAL
    ...
    <div class="story-section dark">
        ...
        <div style="margin: 50px 0;">
            ...
            <div class="principles-grid">
                <div style="background: rgba(255,255,255,0.15); padding: 25px; border-radius: 12px; backdrop-filter: blur(10px); border: 2px solid rgba(255,255,255,0.3);">
    ...
    with col2:
        ...
        <div style="text-align: center;">
            <a href="mailto:ebetancurc@sura.com" style="text-decoration: none;">
                <button style="background: white; color: #0072CE; border: none; padding: 12px 30px; border-radius: 8px; font-weight: 600; cursor: pointer; width: 100%;">
                    📧 Contactar
                </button>
            </a>
        </div>
